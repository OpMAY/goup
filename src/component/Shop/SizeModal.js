...
const SizeModal = ({product, confirmClcik}) => {
  ...
  return (
    ...
    >
        ...
        <div className='modal-body'>
            ...
            <Grid item xs={4}>  
                <div className='size-box'>
                    <button type='button' className='size-btn'>
                        <span className='size-name'>ONE SIZE</span><br/>
                        <i className='bokkmark-icon'><BookmarkBorderIcon sx={{width: 16, height: 16}}/></i>
                    </button>
                    </div>
                </Grid>
            ...
            <button className='check' onClick={confirmClcik}>확인</button>
        </div>
        </Box>
    </Modal>
  )
