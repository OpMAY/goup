                    ...
                    <Box sx={style}>
                        ...
                        <Box
                            ...
                            <TextField
                                ...
                                variant="standard"
                                fullWidth
                                placeholder={address.address ? "건물, 아파트, 동/호수 입력" : "우편 번호 검색 후 입력 가능합니다."}
                                value={address.address_detail}
                                InputLabelProps={{
                                    shrink: true,
                                    sx: {color: "#222", fontWeight: "700"},
                                }}
                                inputProps={ !address.address ? {
                                   readOnly: true
                                } : {}}
                                onChange={(e) => setAddress(prevState => {
                            ...
                            />
                            <FormControlLabel
                                control={<Checkbox checked={address.isDefault} onChange={(e) => setAddress(prevState => {
