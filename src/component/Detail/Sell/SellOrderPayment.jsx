        ...
        axiosPostFunction(
          ...
          if (res.data.data.status) {
            res.data.data.result_type === "ORDER_CREATED"
              ? alert("즉시 판매가 완료되었습니다.")
              : alert("판매 입찰 신청이 완료되었습니다");
              ...
              <Box sx={{ padding: "32px 32px" }}>
                <div className="section final_info_box">
                  ...
                  <PriceInputBox>
                    ...
                    <span>
                      {(
                        Number(wishPrice.replaceAll(",", "")) - 9000
                      ).toLocaleString()}
                      원
                    </span>
                  </PriceInputBox>
                  ...
                  <Stack direction="row" justifyContent="space-between">
                    <Box sx={{ color: "rgba(34,34,34,.5)" }}>
                      <Stack direction="row">
                        ...
                        <Typography
                          sx={{ fontSize: "14px", marginLeft: "40px" }}>
                          {receiptInfo && receiptInfo.cash_receipt_type !== null
                            ? getReceiptType(receiptInfo.cash_receipt_type)
                            : "미신청"}
                        </Typography>
                      </Stack>
                      {receiptInfo &&
                      receiptInfo.cash_receipt_type !== null &&
                      receiptInfo.cash_receipt_type !== "NONE" ? (
                        <>
                          <Stack direction="row">
                            ...
                            <Typography
                              ...
                              {getReceiptType(receiptInfo.cash_receipt_type) ===
                              "휴대폰"
                                ? receiptInfo.cr_phone_number
                                : receiptInfo.cr_card_number}
                            </Typography>
                          </Stack>
                        </>
                      ) : null}
                      <Typography sx={{ fontSize: "14px" }}>
                        판매 거래 시 수수료에 대해 건별로 현금영수증을
                        발급합니다.
                      </Typography>
                    </Box>
                    <RecipeInfoModal
